...
<nav class="navbar navbar-expand-lg bg-primary navbar-dark">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="Glass.jsp">Glass</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container mt-5">
    <form action="act" method="post" class="border p-4 shadow w-50 mx-auto">
        <h2 class="text-center mb-4">Glass Details</h2>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="material" placeholder="Enter material" required />
        </div>
